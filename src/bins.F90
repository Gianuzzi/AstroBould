...
contains
    ...
    ! Initialize bins
    subroutine allocate_bins_impl(self, Nbins, rmin, rmax, binning_method)
        implicit none
    ...
    ! Set disk center
    subroutine set_center_impl(self, center)
        implicit none
        type(my_bins), intent(inout) :: self
    ...
    subroutine get_particles_bins_impl(self, particles_dist, particles_bins, dist_is_sorted)
        implicit none
        type(my_bins), intent(inout) :: self
    ...
    subroutine calculate_mass_impl(self, particles_dist, particles_mass, particles_bins)
        implicit none
        type(my_bins), intent(inout) :: self
    ...
    subroutine calculate_force_impl(self, particle_bin, particle_pos, particle_dist, order_legendre, particle_acc)
        implicit none
    ...
    function find_bin(self, dist) result(bin)
        type(my_bins), intent(in) :: self
    ...
    subroutine free_bins_impl(self)
        implicit none
        type(my_bins), intent(inout) :: self
