module constants
    ...
    real(kind=8), parameter :: epsilon    = 1.0d-17 ! Precisión / Error [Usado en elem y coord]
    real(kind=8), parameter :: tini       = 1.d-50 ! Lowest value
    real(kind=8), parameter :: unit_mass  = 1.d-17 ! [kg]
