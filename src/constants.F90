module constants
    ...
    real(kind=8), parameter :: epsilon    = 1.0d-12 ! Precisión / Error [Usado en elem y coord]
    ...
    real(kind=8), parameter :: unit_angm  = unit_mass * unit_dist / unit_vel * 1.d6   ! [kg m² day⁻¹]
    real(kind=8), parameter :: unit_ener  = unit_angm / unit_time ! [kg m² day⁻²]
